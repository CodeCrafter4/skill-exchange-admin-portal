...
class BlockedEmployersScreen extends StatefulWidget
{

  @override
  State<BlockedEmployersScreen> createState() => _BlockedEmployersScreenState();
}



class _BlockedEmployersScreenState extends State<BlockedEmployersScreen>
{
  ...
  Widget build(BuildContext context)
  {
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          showReusableSnackBar(
                            context,
                            "${"Total unit = ".toUpperCase()}unit ${allBlockedSellers!.docs[index].get("unit")}",
                          );
                        },
                        child: Padding(
                          padding: const EdgeInsets.only(top: 18.0, bottom: 8.0),
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                "unit " + allBlockedSellers!.docs[index].get("unit").toString(),
                                style: const TextStyle(
                                  color: Colors.amber,
                                ),
                              ),
    ...
    return Scaffold(
      appBar: NavAppBar(title: "Blocked Employers",),
      body: Center(
        child: SizedBox(
