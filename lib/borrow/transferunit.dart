...
class TransferUnit extends StatefulWidget
{
  String employerID;
  TransferUnit(this. employerID);


  @override
  State<TransferUnit> createState() => _TransferUnitState();
}



class _TransferUnitState extends State<TransferUnit>
{
  TextEditingController borrowTextEditingController = TextEditingController();
    ...
    return showDialog(
        ...
        builder: (BuildContext context)
        {
          return AlertDialog(
            ...
            content: const Text(
              "Do you want to Borrow, for this account ?",
              style: TextStyle(
                fontSize: 16,
                letterSpacing: 2,
              ),
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: ()
                {
                  ...
                  {
                    "unit": borrowTextEditingController.value.text,
                  };
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: borrowTextEditingController,
                          minLines: 2,
                          maxLines: 10,
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                        if(borrowTextEditingController.text.isNotEmpty)
                        {
