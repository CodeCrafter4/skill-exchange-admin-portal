...
class _VerifiedUsersScreenState extends State<VerifiedUsersScreen>
{
  ...
  Widget build(BuildContext context)
  {
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          showReusableSnackBar(
                            context,
                            "${"Total Earnings = ".toUpperCase()}units ${allApprovedUsers!.docs[index].get("unit")}",
                          );
                        },
                        child: Padding(
                          padding: const EdgeInsets.only(top: 18.0, bottom: 8.0),
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                "unit ${allApprovedUsers!.docs[index].get("unit")}",
                                style: const TextStyle(
                                  color: Colors.amber,
                                ),
                              ),
    ...
    return Scaffold(
      appBar: NavAppBar(title: "Verified Freelancers",),
      body: Center(
        child: SizedBox(
